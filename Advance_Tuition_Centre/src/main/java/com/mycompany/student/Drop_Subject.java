...
public class Drop_Subject {
	...
	public static void Drop_Subject(Student user) {
		...
		base = new Base_Frame("Drop Subject", 500, 450);
		...
		Label_Frame title_content_label = new Label_Frame("Drop Subject Request", 165, 10, 200, 24);
		title_content_label.font(17);
	...
	private static void update(Student user) {
		...
		String message = "I would like to drop the " + currentS + " subject";
		...
		String new_request_data = String.format("%s;%s;%s;%s;%s;pending", request_id, student_id, message,
